...
class FormBlockTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testGetInputElement()
    {
        ...
        $this->assertInstanceOf('FewAgency\FluentForm\FormInput\AbstractFormControl', $b->getInputElement());
    }
    ...
    public function testGetFormBlockContainer()
    {
        ...
        $this->assertInstanceOf('FewAgency\FluentForm\FormBlockContainer\AbstractControlBlockContainer',
